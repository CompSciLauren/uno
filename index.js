...
function showMeCheats() {
  ...
  console.log(" ");
  console.log(
    'giveMeABreak("Color", Value) -- Adds a specific card to players hand'
  );
  ...
  console.log(" ");
  console.log(
    "forceDraw(number) -- Draws the specific number of cards from the deck and adds to the player's hand"
  );
  console.log(" ");
  console.log(
    "forceRemove(number) -- Removes the specific number of cards (Must leave 2 or more) from the player's hand starting at the leftmost card"
  );
}
